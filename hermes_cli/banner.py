...
# prompt_toolkit is a Phase-6 dependency; until it lands we fall back to
# plain print(), which still renders ANSI on modern terminals (Win10+,
# all *nix).  Identifiers `_pt_print` / `_PT_ANSI` are kept so cherry-
# picks from upstream that reference them apply cleanly.
def _pt_print(text):
    print(text)
